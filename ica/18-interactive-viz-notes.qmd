...
```{r reading}
#| eval: false
data_by_dist <- read_rds("diverse_data_by_dist.rds")
data_by_year <- read_csv("diverse_data_by_year.csv")
```
...
numericInput(inputId = "min_year", label = "Minimum Year", value = 2000)
numericInput(inputId = "max_year", label = "Maximum Year", value = 2020)
